!(function (e, t) {
						...
						(m = L(
							...
							(u = function (e, t, n, s, u) {
								...
								if (((v += y), a && y !== v)) {
									...
									if (e) {
										if (0 < v) for (; y--; ) b[y] || x[y] || (x[y] = H.call(s));
										x = Te(x);
									}
									W.apply(s, x),
										u &&
	...
	(w.filter = function (e, t, n) {
		...
		w.fn.extend({
			...
			is: function (e) {
				return !!N(this, "string" == typeof e && k.test(e) ? w(e) : e || [], !1)
					.length;
			},
		});
	var H,
				...
				var n = [
					...
					i = {
						...
						then: function (t, r, i) {
							...
							return w
								.Deferred(function (e) {
									n[0][3].add(s(0, e, g(i) ? i : P, e.notifyWith)),
					  ...
					  "" === r.style.display &&
							...
							(c[u] =
								...
								(l = ue[a]) ||
									...
									"none" === l && (l = "block"),
									(ue[a] = l)))))
					: "none" !== n && ((c[u] = "none"), G.set(r, "display", n)));
		...
		if (
			...
			for (l = (a = w.map(me(i, "script"), Re)).length; f < p; f++)
				(c = i),
					...
					n.call(e[f], c, f);
			if (l)
				for (u = a[a.length - 1].ownerDocument, w.map(a, Me), f = 0; f < l; f++)
					(c = a[f]),
						he.test(c.type || "") &&
	...
	function Ye(e, t, n) {
		for (var r, i = t ? w.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
			n || 1 !== r.nodeType || w.cleanData(me(r)),
				r.parentNode &&
					(n && oe(r) && ve(me(r, "script")), r.parentNode.removeChild(r));
		return e;
	}
	w.extend({
		...
		clone: function (e, t, n) {
			...
			if (t)
				if (n)
					for (o = o || me(e), s = s || me(u), r = 0, i = o.length; r < i; r++)
						Pe(o[r], s[r]);
				else Pe(e, u);
			return (
	...
	function et(e, t, n, r, i, o) {
		...
		for (; s < 4; s += 2)
			"margin" === n && (l += w.css(e, n + re[s], !0, i)),
				r
					? ("content" === n && (l -= w.css(e, "padding" + re[s], !0, i)),
					  "margin" !== n &&
	...
	w.extend(w.event, {
		trigger: function (t, n, i, o) {
			...
			if (
				...
				if (!o && !d.noBubble && !m(i)) {
					for (
						c = d.delegateType || y, Tt.test(c + y) || (a = a.parentNode);
						a;
						a = a.parentNode
					)
						v.push(a), (l = a);
				...
				return (
					...
					o ||
						...
						(u &&
							...
							((l = i[u]) && (i[u] = null),
							(w.event.triggered = y),
							t.isPropagationStopped() && h.addEventListener(y, Et),
							i[y](),
							t.isPropagationStopped() && h.removeEventListener(y, Et),
						...
						c
							? (h.ifModified &&
							  ...
							  204 === t || "HEAD" === h.type
									...
									: 304 === t
									? (E = "notmodified")
									: ((E = x.state), (p = x.data), (c = !(d = x.error))))
							: ((d = E), (!t && E) || ((E = "error"), t < 0 && (t = 0))),
						(C.status = t),
						(C.statusText = (n || E) + ""),
						c ? v.resolveWith(g, [p, E, C]) : v.rejectWith(g, [C, E, d]),
						C.statusCode(b),
						(b = void 0),
	...
	w.ajaxSetup({
		...
		w.each(["top", "left"], function (e, t) {
			w.cssHooks[t] = $e(h.pixelPosition, function (e, n) {
				if (n)
					return (n = Fe(e, t)), Xe.test(n) ? w(e).position()[t] + "px" : n;
			});
		}),
	...
	(function (e, t) {
		...
		function o(e) {
			...
			for (
				var n = i(10) ? document.body : null, r = e.offsetParent || null;
		...
		for (
			var q = Math.min,
				...
				X = Math.round,
				I = Math.max,
				B = "undefined" != typeof window && "undefined" != typeof document,
					...
					keepTogether: {
						...
						fn: function (e) {
							var t = e.offsets,
								...
								c = s ? "width" : "height";
							return (
								n[a] < o(r[l]) && (e.offsets.popper[l] = o(r[l]) - n[c]),
					...
					arrow: {
						...
						fn: function (e, n) {
							...
							var o = e.placement.split("-")[0],
								...
								g = c ? "bottom" : "right",
								m = E(i)[u];
							l[g] - m < a[p] && (e.offsets.popper[p] -= a[p] - (l[g] - m)),
								l[p] + m > a[g] && (e.offsets.popper[p] += l[p] + m - a[g]),
							...
							return (
								(w = I(q(a[u] - m, w), 0)),
								(e.arrowElement = i),
								(e.offsets.arrow = (Q((r = {}), p, X(w)), Q(r, h, ""), r)),
								e
							);
						},
						element: "[x-arrow]",
		...
		var w = function (e, t, n, r, i) {
							...
							t.settings.useBothWheelAxes
								? t.scrollbarYActive && !t.scrollbarXActive
									? (s
											...
											: (i.scrollTop += o * t.settings.wheelSpeed),
									  (a = !0))
									: t.scrollbarXActive &&
									  !t.scrollbarYActive &&
									  (o
											? (i.scrollLeft += o * t.settings.wheelSpeed)
											: (i.scrollLeft -= s * t.settings.wheelSpeed),
									  (a = !0))
								: ((i.scrollTop -= s * t.settings.wheelSpeed),
								  (i.scrollLeft += o * t.settings.wheelSpeed)),
								E(t),
					...
					function n(e, n) {
						...
						if (s > o) {
							if (
								...
								return 0 === window.scrollY && n > 0 && T.isChrome;
						} else if (
							o > s &&
			...
			S = function (r, i) {
				...
				(this.scrollbarYRight = parseInt(f.right, 10)),
					...
					(this.railYMarginHeight = u(f.marginTop) + u(f.marginBottom)),
